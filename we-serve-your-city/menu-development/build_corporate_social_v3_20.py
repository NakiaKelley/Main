...
v3.20 — Corporate & Social Menu

Edits from v3.19:
  6. Page numbers added to interior page footers (cover unnumbered).
     Format: "vX.YZ   |   Page N", right-aligned in the footer.
...
if __name__ == '__main__':
    out = os.path.join(SCRIPT_DIR, 'Citizens_Corporate_Social_v3.20.pdf')
    build_corporate(out, version="v3.20")
    print("All done.")
