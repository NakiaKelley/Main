...
Edits from v3.18:
  ...
  5. SEAFOOD subsection header: keep with content (no orphan at bottom of page)
     -> handled by PageManager.cat() reserving header height + min content row
"""
...
if __name__ == '__main__':
    out = os.path.join(SCRIPT_DIR, 'Citizens_Corporate_Social_v3.19.pdf')
    build_corporate(out, version="v3.19")
    print("All done.")
